    ...
    return (
        ...
        >
            ...
            {props.id_categorie_allergene !== 0 ? 
                <div>
                    <GiGearHammer className={styles.icone} onClick={() => history.push(`category/allergene/modify/${props.id_categorie_allergene}`)} />
                    <GiArchiveResearch className={styles.icone} onClick={() => history.push(`/liste des allergenes/byCategorie/${props.id_categorie_allergene}`)}/>
                </div>
            : 
                null
            }
